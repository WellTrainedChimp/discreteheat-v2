    ...
    return (
        <>
            ...
            <main className="min-h-screen bg-dh-grey-light selection:bg-dh-red/20 selection:text-dh-red pt-0">
                ...
                <CaseStudySection
                    heading="A Home Designed Without a Single Radiator"
                    description="When Nick built his new home, he didn't just replace radiators — he eliminated them entirely. ThermaSkirt H2O runs through every room as the sole heat emitter, paired with an air source heat pump. The result: no furniture restrictions, no hot metal surfaces, no convection drafts. Just warm skirting boards and total design freedom throughout the house."
                    mediaId="672glg6n1w"
                    caption="Nick's radiator-free home — ThermaSkirt as the only emitter in every room."
                />
