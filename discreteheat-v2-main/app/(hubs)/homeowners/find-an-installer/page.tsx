...
export const metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://www.discreteheat.com/MediaHandler.ashx?id=8e875883-9f9d-468d-9c61-d3da58e23f5f', width: 1200, height: 630, alt: 'Find a Registered ThermaSkirt Installer | DiscreteHeat' }],
    },
};
        ...
        <>
            ...
            <main className="min-h-screen bg-dh-grey-light selection:bg-dh-red/20 selection:text-dh-red pt-0">
                ...
                <section className="py-20 px-6 lg:px-12 bg-white">
                    <div className="max-w-4xl mx-auto space-y-12">
                        ...
                        <div className="bg-dh-grey-light p-8 rounded-xl my-16 text-center border border-dh-grey/20">
                            <h3 className="text-2xl font-semibold text-dh-dark mb-4">Get Matched With a Local Installer</h3>
                            <p className="text-dh-grey mb-8 max-w-2xl mx-auto">
                                We qualify every project before referring one of our Registered Installers, ensuring they have the full technical details needed to quote accurately and start promptly. To be matched with a trained professional in your area, the first step is to request a ThermaSkirt design and quote from our team.
                            </p>
                        ...
                        <article>
                            <span className="block text-[13px] font-semibold uppercase tracking-[0.08em] text-dh-red mb-4">Confident DIYer?</span>
                            <h3 className="text-2xl font-light text-dh-dark mb-6 tracking-tight">Install It Yourself</h3>
                            <p className="text-lg text-dh-grey leading-relaxed mb-6">
                            ...
                            <Link
                                href="/homeowners/diy-or-professional"
                                className="inline-flex items-center text-dh-red font-semibold hover:underline group"
                            >
                ...
                <FAQText
                    faqs={[
                        ...
                        },
                        {
                            ...
                            answer: "We ask all prospective installers for copies of their relevant trade qualifications and proof of valid public liability insurance before they are accepted onto the programme. They must then successfully complete our hands-on technical training at our Manchester facility."
                        },
                        {
                            question: "Who is responsible for the warranty?",
                            answer: "DiscreteHeat provides a 10-year warranty covering all wet system parts and any manufacturing defects. The labour warranty — covering all installation elements, finishing details, and system performance — sits with the installer, the same as it would with a standard radiator installation. This is why we always recommend using a trained professional."
                        }
                    ]}
                />
                ...
                <CTABanner
                    ...
                    secondaryCTA="Become an Installer"
                    secondaryCTALink="/trade/installer-programme/register"
                />
            </main>
        </>
    );
