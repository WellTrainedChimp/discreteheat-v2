...
export const metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://www.discreteheat.com/MediaHandler.ashx?id=89b3f691-9bbc-4268-941a-8ba213267301', width: 1200, height: 630, alt: 'Open Plan Home Heating | ThermaSkirt' }],
    },
};
        ...
        <>
            ...
            <main className="min-h-screen bg-dh-grey-light selection:bg-dh-red/20 selection:text-dh-red pt-0">
                <SubHubHero
                    ...
                    imageSrc="https://www.discreteheat.com/MediaHandler.ashx?id=89b3f691-9bbc-4268-941a-8ba213267301"
                ...
                <section className="py-20 px-6 lg:px-12 bg-white">
                    <div className="max-w-4xl mx-auto space-y-12">
                        ...
                        <RoomImageCarousel roomSlug="open-plan" />
