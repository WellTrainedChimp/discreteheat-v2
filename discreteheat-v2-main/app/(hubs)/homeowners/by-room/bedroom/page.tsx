...
export const metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://www.discreteheat.com/MediaHandler.ashx?id=9d650245-84b3-433b-bc74-32223612fdfe', width: 1200, height: 630, alt: 'Bedroom Skirting Board Heating | ThermaSkirt' }],
    },
};
        ...
        <>
            ...
            <main className="min-h-screen bg-dh-grey-light selection:bg-dh-red/20 selection:text-dh-red pt-0">
                <SubHubHero
                    ...
                    imageSrc="https://www.discreteheat.com/MediaHandler.ashx?id=9d650245-84b3-433b-bc74-32223612fdfe"
                ...
                <section className="py-20 px-6 lg:px-12 bg-white">
                    <div className="max-w-4xl mx-auto space-y-12">
                        ...
                        <RoomImageCarousel roomSlug="bedroom" />
                ...
                <CaseStudySection
                    heading="Controllable Bedroom Heating with High-Tog Carpets"
                    description="In Emma and Dan's newly built upstairs bedrooms, ThermaSkirt delivered exactly the responsive, controllable warmth they needed. Unlike underfloor heating — which would have struggled under the thick bedroom carpets they chose — ThermaSkirt radiates heat directly into the room from the skirting line. The bedrooms heat up in minutes and cool down just as fast, giving them precise comfort control night and day."
                    mediaId="888x825p0o"
                    caption="Emma & Dan's bedrooms — ThermaSkirt with high-tog carpets, fast response, silent operation."
                />
