        ...
        <>
            ...
            <main className="min-h-screen bg-dh-grey-light selection:bg-dh-red/20 selection:text-dh-red pt-0">
                <SubHubHero
                    ...
                    videoSrc="/assets/videos/hero_kitchen.mp4"
                />
                ...
                <CaseStudySection
                    heading="Extension Meets Existing Home — Seamlessly"
                    description="Emma and Dan added an entire upper storey to their 1970s bungalow. Rather than battling with underfloor heating on timber joists or running mismatched radiators, they fitted ThermaSkirt throughout the new first-floor extension. It connected directly to the existing gas boiler downstairs, bridging old and new without blending valves or secondary pumps."
                    mediaId="888x825p0o"
                    caption="Emma & Dan's upper-storey extension — ThermaSkirt integrated with the existing boiler system."
                />
