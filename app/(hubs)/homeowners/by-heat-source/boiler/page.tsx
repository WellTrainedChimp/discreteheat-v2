            ...
            <main className="min-h-screen bg-dh-grey-light selection:bg-dh-red/20 selection:text-dh-red pt-0">
                ...
                <section className="py-20 px-6 lg:px-12 bg-white">
                    <div className="max-w-4xl mx-auto">
                        <span className="block text-[13px] font-semibold uppercase tracking-[0.08em] text-dh-red mb-4">Case Study</span>
                        <h2 className="text-3xl font-light text-dh-dark mb-4 tracking-tight">Renovation &amp; Extension — Gas Boiler with ThermaSkirt Upstairs</h2>
                        <p className="text-lg text-dh-grey leading-relaxed mb-6">
